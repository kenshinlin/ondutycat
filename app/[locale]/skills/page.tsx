...
const mockSkills: Skill[] = [
  {
    ...
    problemDescription: 'Handles database connection timeout and connection pool exhaustion issues',
...
7. Restart application connection pool if needed`,
  ...
  },
  {
    ...
    problemDescription: 'Investigates and resolves high memory consumption issues',
...
7. Recommend memory limit adjustments if needed`,
  ...
  },
  {
    ...
    problemDescription: 'Handles slow API response time and endpoint performance issues',
...
export default function SkillsPage() {
  ...
  const filteredSkills = mockSkills.filter((skill) => {
    const matchesSearch =
      ...
      skill.problemDescription.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  const handleToggleStatus = (skill: Skill) => {
    ...
    console.log('Toggle status:', skill.id, skill.status === 'active' ? 'inactive' : 'active');
  };
      ...
      <div className="flex-none px-6 py-4 border-b border-border bg-card">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Problem-solving SOPs for AI agent</p>
            </div>
          </div>
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          <select
            ...
            onChange={(e) => setSelectedStatus(e.target.value as SkillStatus | 'all')}
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <Badge variant={skill.status === 'active' ? 'success' : 'default'} className="mt-1">
                          {skill.status}
                        </Badge>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 text-xs text-muted-foreground">
                      {skill.createdBy && (
                        <div className="flex items-center gap-1">
                          ...
                          <span className="truncate max-w-[100px]">{skill.createdBy}</span>
                        </div>
                      )}
                      <div className="flex items-center gap-1">
